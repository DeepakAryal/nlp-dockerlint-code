"""
Evaluate Stage 1 CodeBERT model for Dockerfile misconfiguration detection.
...
MODEL_DIR = "saved_models/stage1_codebert/last_checkpoint"
TOKENIZED_TEST_DIR = "data/codebert/tokenized_chunks-stage1/test"
BATCH_SIZE = 32
...
print(f"[INFO] Loading CodeBERT model from {MODEL_DIR} ...")
...
plt.title("Stage 1 CodeBERT ROC Curve")
