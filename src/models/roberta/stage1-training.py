"""
Roberta-base chunked training (Stage 1 binary classification)
...
MODEL_SAVE_DIR = "saved_models/stage1_roberta"
os.makedirs(MODEL_SAVE_DIR, exist_ok=True)

CHUNKS_DIR = "data/roberta/tokenized_chunks-stage1/train"
VAL_CHUNKS_DIR = "data/roberta/tokenized_chunks-stage1/val"
...
for epoch in range(start_epoch, EPOCHS):
    ...
    for chunk_idx, chunk_file in enumerate(tqdm(train_chunks, desc="Train chunks", ncols=120), start=1):
